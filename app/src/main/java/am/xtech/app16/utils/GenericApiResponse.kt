    ...
    companion object {
        ...
        fun <T> create(error: Throwable): ApiErrorResponse<T> {
            return ApiErrorResponse(
                error.message ?: "unknown error",444
        ...
        fun <T> create(response: Response<T>): GenericApiResponse<T> {
            ...
            if(response.isSuccessful){
                ...
                if (body == null || response.code() == 204) {
                    ...
                    return ApiErrorResponse("401 Unauthorized. Token may be invalid.",401)
                }
                else {
...
data class ApiErrorResponse<T>(val errorMessage: String,val code:Int) : GenericApiResponse<T>()
